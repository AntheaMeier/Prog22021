...
//im Konstruktor einen Zug machen dem from-Point(fromRow, fromCol) zum to-Point(toRow, toCol)
	...
	/*
	in diesem folgenden Konstruktor werden in this.from und this.to nicht einfach
